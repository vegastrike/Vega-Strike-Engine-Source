...
enum VSFileType {
    ...
    AccountFile,                                                //Loaded from data_dir/accounts and written in data_dir/accounts
    //Buffer types
    ZoneBuffer,                                                         //Indicates a ZoneInfo buffer coming from server
    JPEGBuffer,                                                         //Indicates a JPEG buffer coming from network
    //Unknown
    UnknownFile                                                         //Loaded from homedir or data_dir and written in homedir
};
...
extern std::vector<std::string> curdir;        //current dir starting from data_dir
extern std::vector<std::string> savedpwd;
extern std::vector<std::string> Rootdir;
extern std::string shared_textures;
extern std::string shared_sounds;
extern std::string shared_meshes;
extern std::string shared_units;
...
/*
 *  void initpaths(const std::string& modname="");			// Sets up data_dir and load VS config file
