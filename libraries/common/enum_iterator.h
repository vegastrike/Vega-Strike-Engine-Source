...
#ifndef VEGA_STRIKE_LIBRARIES_COMMON_ENUM_ITERATOR_H
#define VEGA_STRIKE_LIBRARIES_COMMON_ENUM_ITERATOR_H
...
#endif //VEGA_STRIKE_LIBRARIES_COMMON_ENUM_ITERATOR_H
