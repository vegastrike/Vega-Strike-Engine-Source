...
#define WID 128
#define HEI 64
void ModifyImage(unsigned int sizex,unsigned int sizey,int img_depth,int img_alpha,unsigned char **row_pointers, int nw,int nh, unsigned char out[HEI][WID][3]) {
  int stride = (img_depth/8)*(img_alpha?4:3);
