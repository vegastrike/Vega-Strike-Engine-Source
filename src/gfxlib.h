 ...
 */
GFXBOOL /*GFXDRVAPI*/ GFXTransferTexture(unsigned char *buffer, int handle, int inWidth, int inHeight, enum TEXTUREFORMAT internalformat, enum TEXTURE_IMAGE_TARGET image2D=TEXTURE_2D, int max_texture_dimension=65536/*make sure it's not bigger than this--usually maybe 65536*/,GFXBOOL detailtexture=GFXFALSE, unsigned int pageIndex=0);
