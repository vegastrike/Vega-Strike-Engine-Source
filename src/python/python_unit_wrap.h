...
////////////////////////////AUTOMATIC WRAP//////
  ...
  WRAPPED2(QVector, PositionITTS ,const QVector &, local_posit, float, speed,QVector(0,0,0))
  WRAPPED0(QVector,Position,QVector(0,0,0))
  WRAPPED0(QVector, LocalPosition,QVector(0,0,0))
  WRAPPED0(UnitWrapper,Target,0)
  WRAPPED0(UnitWrapper, VelocityReference,0)
  WRAPPED0(UnitWrapper, Threat,0)
  voidWRAPPED1( Target ,UnitWrapper, targ)
  voidWRAPPED1( VelocityReference, UnitWrapper,targ)
  ...
  WRAPPED1(double, getMinDis,const QVector &,pnt,0)//for clicklist
  WRAPPED3(float, querySphere, const QVector &,start, const QVector & ,end, float ,my_unit_radius,0)
  WRAPPED3(int, queryBoundingBox,const QVector &,origin,const Vector &,direction, float, err,0)
  ...
  voidWRAPPED1( SetPosition,const QVector &,pos)
  voidWRAPPED1( SetCurPosition ,const QVector &, pos)
  voidWRAPPED1( SetPosAndCumPos ,const QVector &,pos)
  voidWRAPPED1( Rotate,const Vector &,axis)
  voidWRAPPED1( ApplyForce,const Vector &,Vforce) 
  voidWRAPPED1( ApplyLocalForce,const Vector &,Vforce) 
  voidWRAPPED1( Accelerate,const Vector &,Vforce) 
  voidWRAPPED2( ApplyTorque ,const Vector &,Vforce, const QVector &,Location)
  voidWRAPPED2( ApplyLocalTorque ,const Vector &,Vforce, const Vector &,Location)
  voidWRAPPED2( ApplyBalancedLocalTorque ,const Vector &,Vforce, const Vector &,Location) 
  voidWRAPPED1( ApplyLocalTorque,const Vector &,torque) 
  WRAPPED2(float, DealDamageToHull ,const Vector &,pnt, float, Damage,0)
  WRAPPED2(Vector, ClampThrust,const Vector &,thrust, bool, afterburn,Vector(0,0,0))
  voidWRAPPED2( Thrust,const Vector &,amt,bool, afterburn )
  voidWRAPPED1( LateralThrust,float, amt)
  voidWRAPPED1( VerticalThrust,float, amt)
  voidWRAPPED1( LongitudinalThrust,float, amt)
  WRAPPED2(Vector, ClampVelocity ,const Vector &, velocity, const bool, afterburn,Vector(0,0,0))
  WRAPPED1(Vector, ClampAngVel ,const Vector &, vel,Vector(0,0,0))
  WRAPPED1(Vector, ClampTorque,const Vector &,torque,Vector(0,0,0))
  voidWRAPPED2( SetOrientation ,QVector ,q, QVector, r)
  WRAPPED1(Vector, UpCoordinateLevel,const Vector &,v,Vector(0,0,0))
  WRAPPED1(Vector, DownCoordinateLevel,const Vector &,v,Vector(0,0,0))
  WRAPPED1(Vector, ToLocalCoordinates,const Vector &,v,Vector(0,0,0))
  WRAPPED1(Vector, ToWorldCoordinates,const Vector &,v,Vector(0,0,0))
  WRAPPED0(const Vector &,GetAngularVelocity,Vector(0,0,0))
  WRAPPED0(const Vector &,GetVelocity,Vector(0,0,0))
  voidWRAPPED1( SetVelocity ,const Vector &, v)
  voidWRAPPED1( SetAngularVelocity ,const Vector &, v)
