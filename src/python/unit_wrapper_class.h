...
#define EXPORT_UTIL3(type,name,atype,a,btype,b,ctype,c) type name ( atype a, btype b , ctype c ){ return UnitUtil::name ( GetUnit(), a , b , c );}  
#define EXPORT_UTIL5(type,name,atype,a,btype,b,ctype,c,dtype,d,etype,e) type name ( atype a, btype b, ctype c , dtype d , etype e ){ return UnitUtil::name ( GetUnit(), a , b , c , d , e );}  
...
//WRAPPED0(UnitCollection::UnitIterator, getSubUnits,0)
  ...
  boost::python::dictionary GetMountInfo(int index) const;
