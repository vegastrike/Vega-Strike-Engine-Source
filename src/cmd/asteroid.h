...
class GameAsteroid: public GameUnit<Asteroid> {
  public:
	...
	virtual void UpdatePhysics2 (const Transformation &trans, const Transformation &oldtranssmat, const Vector & CumulativeVelocity, bool ResolveLast, UnitCollection *uc=NULL);
protected:
