...
void BaseComputer::constructControls(void) {
...

    {
        ...
        *inv = *sellLabel;
        ...
        sellerScroller->setColor( GFXColor(0,0,.2) );
        ...
        sellpick->setColor( GFXColor(0,0,.2) );
        ...
        sellpick->setSelectionColor(GFXColor(0,.5,.3));
        ...
        descScroller->setColor( GFXColor(0,0,.25) );
