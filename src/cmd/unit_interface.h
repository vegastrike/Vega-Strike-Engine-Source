...
class UpgradingInfo;
void BuyShip( Unit *base,
              Unit *un,
              std::string name,
              bool my_fleet = false,
              UnitContainer *buyer = NULL,
              UpgradingInfo *baseinfo = NULL );
class UpgradingInfo
{
    void DoDone();
...
//end it
    ...
    enum BaseMode
    {
        BUYMODE, SELLMODE, MISSIONMODE, BRIEFINGMODE, NEWSMODE, SHIPDEALERMODE, UPGRADEMODE, ADDMODE, DOWNGRADEMODE,
        SAVEMODE, MAXMODE
    }
    mode;
    bool     multiplicitive;
