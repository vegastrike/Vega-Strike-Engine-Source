...
public:                                                                              \
    ...
    Name(){ limit = length = 0; root = NULL; ExtraConstructor; }                     \
    ~Name(){ SetLimit( 0 ); }                                                        \
    ...
    ga_type&operator[]( int n ){ CS_ASSERT( n >= 0 && n < limit ); return root[n]; } \
    const ga_type& operator[]( int n ) const                                         \
    {                                                                                \
        CS_ASSERT( n >= 0 && n < limit );                                            \
        return root[n];                                                              \
    }                                                                                \
    ga_type&Get( int n ){ CS_ASSERT( n >= 0 && n < limit ); return root[n]; }        \
    void Delete( int n )                                                             \
    {                                                                                \
        CS_ASSERT( n >= 0 && n < limit );                                            \
