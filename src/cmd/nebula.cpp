...
void GameNebula::UpdatePhysics (const Transformation &trans, const Matrix transmat, const Vector & CumulativeVelocity, bool ResolveLast, UnitCollection *uc) {
  ...
  GameUnit<Nebula>::UpdatePhysics (trans,transmat,CumulativeVelocity,ResolveLast,uc);
  Vector t1;
  float dis;
  unsigned int i;
