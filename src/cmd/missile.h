...
public:
  ...
  virtual void UpdatePhysics2 (const Transformation &trans, const Transformation &ops, const Matrix &transmat,float diff,  const Vector & CumulativeVelocity, bool ResolveLast, UnitCollection *uc=NULL){
    Unit * targ;
	if ((targ=(Unit::Target()))) {
    ...
    GameUnit<Missile>::UpdatePhysics2 (trans, ops,transmat,diff, CumulativeVelocity, ResolveLast, uc);
