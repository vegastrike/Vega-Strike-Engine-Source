...
struct UnitImages {
  ...
  enum GAUGES {ARMORF,ARMORB,ARMORR,ARMORL,FUEL, SHIELDF,SHIELDR,SHIELDL,SHIELDB, ENERGY, AUTOPILOT,EJECT, LOCK, HULL,WARPENERGY, KPS, SETKPS, COCKPIT_FPS, NUMGAUGES};
};
