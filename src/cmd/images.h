...
struct UnitImages {
  ...
  enum GAUGES {
      ...
      SETKPS,COCKPIT_FPS,WARPFIELDSTRENGTH,MAXKPS,MAXCOMBATKPS,MAXCOMBATABKPS,MASSEFFECT,
  ...
  enum MODALGAUGEVALUES{
	OFF,ON,SWITCHING,ACTIVE,FAW,MANEUVER,TRAVEL,NOTAPPLICABLE,READY,NODRIVE,TOOFAR,NOTENOUGHENERGY,WARNING,NOMINAL
  };
};
