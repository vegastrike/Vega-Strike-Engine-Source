...
GameFlightgroup::GameFlightgroup ():Flightgroup() {
}

Flightgroup * GameFlightgroup::newGameFlightgroup (const std::string &name, 
...
GameFlightgroup::~GameFlightgroup() {
...
GameFlightgroup& GameFlightgroup::operator = (GameFlightgroup & other) {
