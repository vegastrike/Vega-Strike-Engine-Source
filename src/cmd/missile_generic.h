...
public:
  ...
  virtual void UpdatePhysics2 (const Transformation &trans, const Transformation &oldtransmat, const Vector & CumulativeVelocity, bool ResolveLast, UnitCollection *uc=NULL);
