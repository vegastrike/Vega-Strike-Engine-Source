...
ClientState aim_assist(ClientState cs, ClientState ocs/*old*/,
  ...
  static float cos_min_angle=cos(M_PI*(1./180)*XMLSupport::parse_float(vs_config->getVariable("network","max_lead_prediction_angle","60")));//120 degree leeway for using this method
