...
void Lighting (RGBColor &Col, const Vector &Norm)
{
...
bool LoadTex(char * FileName, unsigned char scdata [256][256][3]){
...
void Spherize (CubeCoord Tex [256][256],CubeCoord gluSph [256][256],unsigned char Col[])
{
	Texmp * Data = NULL;
	bool sphere = false;
	Data = new Texmp[6];
