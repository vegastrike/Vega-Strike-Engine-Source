...
// font. Applied per-instance in TextPlane::Draw; HUD/cockpit TextPlanes keep the default scale
// of 1.0. 1.5/VECTOR_FONT_SCALE (=1.0) puts the base-interface + main-menu TOTAL at 1.5x, i.e.
// the same size as the HUD, down from the earlier 2.0x. The base computer (gui Font) stays 1.5x.
static const float BASE_FONT_SCALE          = 1.5f / VECTOR_FONT_SCALE;
