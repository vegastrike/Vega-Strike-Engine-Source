...
void vs_options::init()
{
	...
	/* Joystick Options */
	joystick_exponent = XMLSupport::parse_float(vs_config->getVariable ("joystick","joystick_exponent","1.0"));
	...
	deadband = XMLSupport::parse_float(vs_config->getVariable ("joystick","deadband","0.05"));
	mouse_deadband = XMLSupport::parse_float(vs_config->getVariable ("joystick","mouse_deadband","0.025"));
	warp_mouse = XMLSupport::parse_bool(vs_config->getVariable ("joystick","warp_mouse","false"));
	mouse_sensitivity = XMLSupport::parse_float(vs_config->getVariable ("joystick","mouse_sensitivity","50.0"));
	mouse_exponent = XMLSupport::parse_float(vs_config->getVariable ("joystick","mouse_exponent","3.0"));
	mouse_blur = XMLSupport::parse_float(vs_config->getVariable("joystick","mouse_blur",".025"));
