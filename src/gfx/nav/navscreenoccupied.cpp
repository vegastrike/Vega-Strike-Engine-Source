...

{
	...
	float answer = 0.0;
		...
		if(percent >=0.1) // 0.1 - n

		{

			if(percent >=0.2) // 0.2 - n

			{

				if(percent >=0.3) // 0.3 - n

				{

					if(percent >=0.4) // 0.4 - n

					{

						if(percent >=0.5) // 0.5 - n

						{

							if(percent >=0.6) // 0.6 - n

							{

								if(percent >=0.7) // 0.7 - n

								{

									if(percent >=0.8) // 0.8 - n
