...
enum VIEWSTYLE {CP_FRONT,CP_BACK,CP_LEFT,CP_RIGHT,CP_VIEWTARGET,CP_CHASE,CP_PAN,CP_PANTARGET,CP_TARGET,CP_FIXED,CP_FIXEDPOS, CP_FIXEDPOSTARGET,CP_NUMVIEWS};
