...
Afterburner::Afterburner(EnergyType type, double usage_factor):
                         EnergyConsumer(type, 
...
Afterburner::Afterburner(EnergyType type, 
                         double usage_factor, 
                         double afterburner_level, 
                         ...
                         0.0),
                         usage_factor(usage_factor) {
    consumption = usage_factor * afterburner_level * mass * simulation_atom_var;
}



/*void Afterburner::WriteUnitString(std::map<std::string, std::string> &unit) {
    unit["Afterburner_Type"] = std::to_string(type);
    unit["Afterburner_Usage_Cost"] = std::to_string(usage_factor);
}*/
