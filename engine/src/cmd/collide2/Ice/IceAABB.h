...
#define AABB_COMMON_METHODS																											\
			...
			const ice_sbyte*	ComputeOutline(const Point& local_eye, ice_sdword& num)												const;	\
			float			ComputeBoxArea(const Point& eye, const Matrix4x4& mat, float width, float height, ice_sdword& num)	const;	\
			bool			IsInside(const AABB& box)																		const;	\
			bool			ComputePlanes(Plane* planes)																	const;	\
			bool			ComputePoints(Point* pts)																		const;	\
			const Point*	GetVertexNormals()																				const;	\
			const ice_udword*	GetEdges()																						const;	\
	...
	class ICEMATHS_API AABB
	{
		...
		inline_			float		GetMin(ice_udword axis)						const		{ return mMin[axis];						}
		//! Get component of the box's max point along a given axis
		inline_			float		GetMax(ice_udword axis)						const		{ return mMax[axis];						}
		...
		inline_			float		GetCenter(ice_udword axis)					const		{ return (mMax[axis] + mMin[axis])*0.5f;	}
		//! Get component of the box's extents along a given axis
		inline_			float		GetExtents(ice_udword axis)					const		{ return (mMax[axis] - mMin[axis])*0.5f;	}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_			BOOL		Intersect(const AABB& a, ice_udword axis)	const
									{
	...
	class ICEMATHS_API AABB
	{
		...
		//! Get component of the box's center along a given axis
		inline_			float		GetCenter(ice_udword axis)					const		{ return mCenter[axis];						}
		//! Get component of the box's extents along a given axis
		inline_			float		GetExtents(ice_udword axis)					const		{ return mExtents[axis];					}
	...
	inline_ void ComputeAABB(AABB& aabb, const Point* list, ice_udword nb_pts)
	{
		if(list)
		{
