...
#define __OPC_HYBRIDMODEL_H__
	...
	struct LeafTriangles
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_	uint32_t	GetNbTriangles()				const	{ return (Data & 15)+1;											}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_	uint32_t	GetTriangleIndex()				const	{ return Data>>4;												}
		inline_	void	SetData(uint32_t nb, uint32_t index)		{ OPASSERT(nb>0 && nb<=16);	nb--;	Data = (index<<4)|(nb&15);	}
	};
	...
	class OPCODE_API HybridModel : public BaseModel
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_				const uint32_t*			GetIndices()		const	{ return mIndices;		}
