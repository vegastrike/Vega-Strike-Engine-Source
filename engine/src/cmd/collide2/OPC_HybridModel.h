...
#define __OPC_HYBRIDMODEL_H__
	...
	struct LeafTriangles
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_	ice_udword	GetNbTriangles()				const	{ return (Data & 15)+1;											}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_	ice_udword	GetTriangleIndex()				const	{ return Data>>4;												}
		inline_	void	SetData(ice_udword nb, ice_udword index)		{ OPASSERT(nb>0 && nb<=16);	nb--;	Data = (index<<4)|(nb&15);	}
	};
	...
	class OPCODE_API HybridModel : public BaseModel
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		override(BaseModel)	ice_udword					GetUsedBytes()		const;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_				const ice_udword*			GetIndices()		const	{ return mIndices;		}

		private:
							ice_udword					mNbLeaves;		//!< Number of leaf nodes in the model
							LeafTriangles*			mTriangles;		//!< Array of mNbLeaves leaf descriptors
							ice_udword					mNbPrimitives;	//!< Number of primitives in the model
							ice_udword*					mIndices;		//!< Array of primitive indices
