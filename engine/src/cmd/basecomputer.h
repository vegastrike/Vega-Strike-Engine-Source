...
bool buyShip(Unit *base_unit, Unit *player_unit, std::string, bool my_fleet, bool force_base_inventory, BaseComputer *);
bool sellShip(Unit *base_unit, const Unit *player_unit, const std::string &, BaseComputer *);
