...
std::string GetSharedTextureHashName(boost::string_view);
std::string GetSharedSoundHashName(boost::string_view);
std::string GetSharedMeshHashName(boost::string_view, const Vector &scale, int faction);
std::string MakeSharedStarSysPath(boost::string_view);
std::string MakeSharedPath(boost::string_view path);
std::string GetCorrectStarSysPath(boost::string_view, bool &autogenerated);
