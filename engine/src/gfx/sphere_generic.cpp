...
SharedPtr<SphereMesh> SphereMesh::constructSphereMesh(SharedPtr<SphereMesh> mesh,
                                                      float radius,
                                                      int stacks,
                                                      int slices,
                                                      const char *texture,
    ...
    const vega_types::SharedPtr<Mesh> ptr_to_return_value = mesh;
...
//    CityLights return_value;
    SharedPtr<CityLights> return_value = MakeShared<CityLights>();
...
vega_types::SharedPtr<CityLights> CityLights::constructCityLights(SharedPtr<CityLights> city_lights,
                                                                  float radius,
                                                                  int stacks,
                                                                  int slices,
                                                                  const char *texture,
