...
void NavComputer::constructControls(void) {
    {
        ...
        baseTitle->setFont(Font(13, 1.75));
        ...
        done->setFont(Font(15, BOLD_STROKE));
...

    {
        ...
        up->setFont(Font(15, BOLD_STROKE));
        up->setId("Up");
        up->setLabel("Up");
        up->setCommand("Up");
        ...
        add->setFont(Font(15, BOLD_STROKE));
        add->setId("Add");
        add->setLabel("Add");
        add->setCommand("Add");
        ...
        edit->setFont(Font(15, BOLD_STROKE));
        ...
        showpath->setFont(Font(15, BOLD_STROKE));
        ...
        rename->setFont(Font(15, BOLD_STROKE));
        rename->setId("Rename");
        ...
        remove->setFont(Font(15, BOLD_STROKE));
        remove->setId("Remove");
        ...
        down->setFont(Font(15, BOLD_STROKE));
        down->setId("Down");
        down->setLabel("Down");
        ...
        showall->setFont(Font(15, BOLD_STROKE));
        ...
        shownone->setFont(Font(15, BOLD_STROKE));
...

    {
        ...
        applyHint->setFont(Font(13, 1.75));
        ...
        source->setFont(Font(15, BOLD_STROKE));
        source->setId("Source");
        ...
        destination->setFont(Font(15, BOLD_STROKE));
        ...
        targetMode->setFont(Font(15, BOLD_STROKE));
        ...
        stringMode->setFont(Font(15, BOLD_STROKE));
        ...
        chainMode->setFont(Font(15, BOLD_STROKE));
        ...
        finished->setFont(Font(15, BOLD_STROKE));
...

    {
        ...
        absolute->setFont(Font(15, BOLD_STROKE));
        ...
        target->setFont(Font(15, BOLD_STROKE));
        target->setId("Target");
        ...
        current->setFont(Font(15, BOLD_STROKE));
...

    {
        ...
        andButton->setFont(Font(15, BOLD_STROKE));
        andButton->setId("And");
        ...
        orButton->setFont(Font(15, BOLD_STROKE));
        orButton->setId("Or");
        ...
        notButton->setFont(Font(15, BOLD_STROKE));
        notButton->setId("Not");
        ...
        removeButton->setFont(Font(15, BOLD_STROKE));
...

    {
        ...
        chain->setFont(Font(15, BOLD_STROKE));
        chain->setId("Chain");
...
void NavComputer::RenameConfirm::init(void) {
    ...
    confirm->setFont(Font(15, BOLD_STROKE));
