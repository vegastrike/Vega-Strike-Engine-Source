...
void NavComputer::constructControls(void) {
    {
        ...
        baseTitle->setFont(Font(configuration().graphics.font_point_flt * 0.79f, 1.75));
        ...
        done->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        ...
        ms->setFont(Font(configuration().graphics.font_point_flt * 0.79f));
...

    {
        ...
        pathList->setFont(Font(configuration().graphics.font_point_flt * 0.79f));
        ...
        up->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        up->setId("Up");
        up->setLabel("Up");
        up->setCommand("Up");
        ...
        add->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        add->setId("Add");
        add->setLabel("Add");
        add->setCommand("Add");
        ...
        edit->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        ...
        showpath->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        ...
        rename->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        rename->setId("Rename");
        ...
        remove->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        remove->setId("Remove");
        ...
        down->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        down->setId("Down");
        down->setLabel("Down");
        ...
        showall->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        ...
        shownone->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
...

    {
        ...
        applyHint->setFont(Font(configuration().graphics.font_point_flt * 0.79f, 1.75));
        ...
        source->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        source->setId("Source");
        ...
        destination->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        ...
        targetMode->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        ...
        stringMode->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        ...
        chainMode->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        ...
        finished->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
...

    {
        ...
        absolute->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        ...
        target->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        target->setId("Target");
        ...
        current->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
...

    {
        ...
        parameterList->setFont(Font(configuration().graphics.font_point_flt * 0.79f));
        ...
        valueBox->setFont(Font(configuration().graphics.font_point_flt * 0.79f));
        ...
        andButton->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        andButton->setId("And");
        ...
        orButton->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        orButton->setId("Or");
        ...
        notButton->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        notButton->setId("Not");
        ...
        removeButton->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        ...
        criteriaList->setFont(Font(configuration().graphics.font_point_flt * 0.79f));
...

    {
        ...
        chainList->setFont(Font(configuration().graphics.font_point_flt * 0.79f));
        ...
        chainTypeList->setFont(Font(configuration().graphics.font_point_flt * 0.79f));
        ...
        chain->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
        chain->setId("Chain");
...
void NavComputer::RenameConfirm::init(void) {
    ...
    pathNameBox->setFont(Font(configuration().graphics.font_point_flt * 0.79f));
    ...
    confirm->setFont(Font(configuration().graphics.font_point_flt * 0.90f, BOLD_STROKE));
